                            ...
                            <div class="list-block main-block t-list-block">
                                <div class="list-content">
                                    <div class="main-img list-img t-list-img">
                                        ...
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="price">Price<span class="divider">|</span><span class="pkg">{{App\Category::find($trip->category_id)->name}}</span></li>
                                                <li class="rating">
                                    ...
                                    <div class="list-info t-list-info">
                                        <h3 class="block-title"><a href="tour-detail-left-sidebar.html">{{$trip->title_al}}</a></h3>
                                        <p class="block-minor"> {{date('j M Y',strtotime($trip->start_date))}}</p>
                                        <p>
                                            {{ str_limit(strip_tags($trip->description_al), 150) }}

                                            @if (strlen(strip_tags($trip->description_al)) > 150)
